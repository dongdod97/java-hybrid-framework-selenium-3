...
public class ExtentReportsManager {
	...
	public synchronized static ExtentReports createExtentReports() {
		ExtentSparkReporter reporter = new ExtentSparkReporter(GlobalConstants.EXTENT_REPORTS_OUTPUT_FOLDER_PATH + "ExtentReports.html");
		...
		extentReports.setSystemInfo("Team", "DongDo-SDET");

...
public class Level_06_Pattern_Objects extends BaseTest {
	...
	public void User_02_Login() {
		...
		Assert.assertTrue(customerInfoPage.isCheckboxCheckedByLabel("Newsletter:"));
	}
	...
	public void User_04_Logout() {
		...
		Assert.assertTrue(homePage.isHeaderLinkDisplayedByText("Register"));
